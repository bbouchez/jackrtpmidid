...
${OBJECTDIR}/_ext/65a73d24/SystemSleep.o: ../../../../../SDK/beb/common_src/SystemSleep.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -I../../RTP-MIDI -I../../../../../SDK/beb/common_src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/65a73d24/SystemSleep.o ../../../../../SDK/beb/common_src/SystemSleep.cpp

${OBJECTDIR}/_ext/65a73d24/network.o: ../../../../../SDK/beb/common_src/network.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/65a73d24
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -I../../RTP-MIDI -I../../../../../SDK/beb/common_src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/65a73d24/network.o ../../../../../SDK/beb/common_src/network.cpp

${OBJECTDIR}/_ext/e6ab54e0/RTP_MIDI.o: ../../RTP-MIDI/RTP_MIDI.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/e6ab54e0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -I../../RTP-MIDI -I../../../../../SDK/beb/common_src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e6ab54e0/RTP_MIDI.o ../../RTP-MIDI/RTP_MIDI.cpp

${OBJECTDIR}/_ext/e6ab54e0/RTP_MIDI_AppleProtocol.o: ../../RTP-MIDI/RTP_MIDI_AppleProtocol.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/e6ab54e0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -I../../RTP-MIDI -I../../../../../SDK/beb/common_src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e6ab54e0/RTP_MIDI_AppleProtocol.o ../../RTP-MIDI/RTP_MIDI_AppleProtocol.cpp

${OBJECTDIR}/_ext/e6ab54e0/RTP_MIDI_Input.o: ../../RTP-MIDI/RTP_MIDI_Input.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/e6ab54e0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -I../../RTP-MIDI -I../../../../../SDK/beb/common_src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e6ab54e0/RTP_MIDI_Input.o ../../RTP-MIDI/RTP_MIDI_Input.cpp

${OBJECTDIR}/_ext/5c0/jackrtpmidid.o: ../jackrtpmidid.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -I../../RTP-MIDI -I../../../../../SDK/beb/common_src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/jackrtpmidid.o ../jackrtpmidid.cpp
