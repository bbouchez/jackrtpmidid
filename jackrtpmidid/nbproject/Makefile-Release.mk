...
${OBJECTDIR}/_ext/5c0/RTP_MIDI.o: ../RTP_MIDI.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/RTP_MIDI.o ../RTP_MIDI.cpp

${OBJECTDIR}/_ext/5c0/RTP_MIDI_AppleProtocol.o: ../RTP_MIDI_AppleProtocol.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/RTP_MIDI_AppleProtocol.o ../RTP_MIDI_AppleProtocol.cpp

${OBJECTDIR}/_ext/5c0/RTP_MIDI_Input.o: ../RTP_MIDI_Input.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/RTP_MIDI_Input.o ../RTP_MIDI_Input.cpp

${OBJECTDIR}/_ext/5c0/XPlatformUtils.o: ../XPlatformUtils.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/XPlatformUtils.o ../XPlatformUtils.cpp

${OBJECTDIR}/_ext/5c0/jackrtpmidid.o: ../jackrtpmidid.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/jackrtpmidid.o ../jackrtpmidid.cpp

${OBJECTDIR}/_ext/5c0/network.o: ../network.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__TARGET_LINUX__ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/network.o ../network.cpp
